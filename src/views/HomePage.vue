...
<template>
  ...
  <div class="mx-auto max-w-7xl"></div>
    <header class="mb-8">
      ...
      <h1 class="mt-2 text-4xl font-black text-white sm:text-5xl">Anime Watchlist</h1>
      ...
      <section class="space-y-5">
        <div class="rounded-3xl border border-slate-700/70 bg-slate-900/60 p-5 shadow-2xl shadow-slate-950/30 backdrop-blur-sm">
          ...
          <div>
              ...
              <p class="text-sm text-slate-300">Pull the lever for another anime recommendation</p>
              </div>
            <button type="button" 
